<template>
    <div class="show-block live">
        ...
        <div class="info">
            ...
            <a :class="[room.sp ? 'prepare' : 'living', 'tag']" :href="'https://live.bilibili.com/' + room.room">
                {{ room.sp ? "已下播" : "直播中" }}
            </a>
            <div class="data">
    ...
    computed: {
        info() {
            return {
                ...
                '营收': (this.room.dataMap || this.room.sp) ? "￥"+(this.room.guard_buy + this.room.send_gift + this.room.super_chat_message).toFixed(2) : "待加载"
            }
        }
    }
}
